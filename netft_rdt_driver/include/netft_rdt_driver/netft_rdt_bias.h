...
public:
  NetFTRDTDriverBias(ros::NodeHandle &nh, double rot,
...
private:
  ...
  bool service_callback(netft_rdt_msgs::String_cmd::Request &request,
                        netft_rdt_msgs::String_cmd::Response &response);

  /// taken from control_toolbox filter.h
  static inline double exponentialSmoothing(double current_raw_value,
